...
class PaginatedHuishoudelijkafvalafvoermomentenListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalafvoermomentenListEmbedded
    """ # noqa: E501
    afvoermomenten: Optional[List[Huishoudelijkafvalafvoermomenten]] = None
    __properties: ClassVar[List[str]] = ["afvoermomenten"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in afvoermomenten (list)
        _items = []
        if self.afvoermomenten:
            for _item_afvoermomenten in self.afvoermomenten:
                if _item_afvoermomenten:
                    _items.append(_item_afvoermomenten.to_dict())
            _dict['afvoermomenten'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "afvoermomenten": [Huishoudelijkafvalafvoermomenten.from_dict(_item) for _item in obj["afvoermomenten"]] if obj.get("afvoermomenten") is not None else None
        })
        return _obj
