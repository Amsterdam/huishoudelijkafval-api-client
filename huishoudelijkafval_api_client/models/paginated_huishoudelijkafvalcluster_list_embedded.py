...
class PaginatedHuishoudelijkafvalclusterListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalclusterListEmbedded
    """ # noqa: E501
    cluster: Optional[List[Huishoudelijkafvalcluster]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cluster": [Huishoudelijkafvalcluster.from_dict(_item) for _item in obj["cluster"]] if obj.get("cluster") is not None else None
        })
        return _obj
