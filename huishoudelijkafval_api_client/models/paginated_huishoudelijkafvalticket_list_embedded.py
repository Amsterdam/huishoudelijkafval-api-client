...
class PaginatedHuishoudelijkafvalticketListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalticketListEmbedded
    """ # noqa: E501
    ticket: Optional[List[Huishoudelijkafvalticket]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ticket": [Huishoudelijkafvalticket.from_dict(_item) for _item in obj["ticket"]] if obj.get("ticket") is not None else None
        })
        return _obj
