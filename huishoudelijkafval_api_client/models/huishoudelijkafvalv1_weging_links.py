...
class Huishoudelijkafvalv1WegingLinks(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalwegingLink = Field(alias="self")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalwegingLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
