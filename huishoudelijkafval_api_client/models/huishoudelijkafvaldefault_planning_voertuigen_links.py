...
class HuishoudelijkafvaldefaultPlanningVoertuigenLinks(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalplanningVoertuigenLink = Field(alias="self")
    werkzaamheden_datum_ref: ReferentiekalenderdatumLink = Field(alias="werkzaamhedenDatumRef")
    __properties: ClassVar[List[str]] = ["schema", "self", "werkzaamhedenDatumRef"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of werkzaamheden_datum_ref
        if self.werkzaamheden_datum_ref:
            _dict['werkzaamhedenDatumRef'] = self.werkzaamheden_datum_ref.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalplanningVoertuigenLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "werkzaamhedenDatumRef": ReferentiekalenderdatumLink.from_dict(obj["werkzaamhedenDatumRef"]) if obj.get("werkzaamhedenDatumRef") is not None else None
        })
        return _obj
