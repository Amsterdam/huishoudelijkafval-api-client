...
class PaginatedHuishoudelijkafvalcontainerlocatieListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalcontainerlocatieListEmbedded
    """ # noqa: E501
    containerlocatie: Optional[List[Huishoudelijkafvalcontainerlocatie]] = None
    __properties: ClassVar[List[str]] = ["containerlocatie"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in containerlocatie (list)
        _items = []
        if self.containerlocatie:
            for _item_containerlocatie in self.containerlocatie:
                if _item_containerlocatie:
                    _items.append(_item_containerlocatie.to_dict())
            _dict['containerlocatie'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containerlocatie": [Huishoudelijkafvalcontainerlocatie.from_dict(_item) for _item in obj["containerlocatie"]] if obj.get("containerlocatie") is not None else None
        })
        return _obj
