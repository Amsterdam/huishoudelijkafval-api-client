...
class PaginatedHuishoudelijkafvalclusterfractieListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalclusterfractieListEmbedded
    """ # noqa: E501
    clusterfractie: Optional[List[Huishoudelijkafvalclusterfractie]] = None
    __properties: ClassVar[List[str]] = ["clusterfractie"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in clusterfractie (list)
        _items = []
        if self.clusterfractie:
            for _item_clusterfractie in self.clusterfractie:
                if _item_clusterfractie:
                    _items.append(_item_clusterfractie.to_dict())
            _dict['clusterfractie'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusterfractie": [Huishoudelijkafvalclusterfractie.from_dict(_item) for _item in obj["clusterfractie"]] if obj.get("clusterfractie") is not None else None
        })
        return _obj
