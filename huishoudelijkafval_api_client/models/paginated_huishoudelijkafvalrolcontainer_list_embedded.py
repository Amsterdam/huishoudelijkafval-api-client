...
class PaginatedHuishoudelijkafvalrolcontainerListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalrolcontainerListEmbedded
    """ # noqa: E501
    rolcontainer: Optional[List[Huishoudelijkafvalrolcontainer]] = None
    __properties: ClassVar[List[str]] = ["rolcontainer"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rolcontainer (list)
        _items = []
        if self.rolcontainer:
            for _item_rolcontainer in self.rolcontainer:
                if _item_rolcontainer:
                    _items.append(_item_rolcontainer.to_dict())
            _dict['rolcontainer'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rolcontainer": [Huishoudelijkafvalrolcontainer.from_dict(_item) for _item in obj["rolcontainer"]] if obj.get("rolcontainer") is not None else None
        })
        return _obj
