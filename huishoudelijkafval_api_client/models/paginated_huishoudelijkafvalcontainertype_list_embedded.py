...
class PaginatedHuishoudelijkafvalcontainertypeListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalcontainertypeListEmbedded
    """ # noqa: E501
    containertype: Optional[List[Huishoudelijkafvalcontainertype]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in containertype (list)
        _items = []
        if self.containertype:
            for _item_containertype in self.containertype:
                if _item_containertype:
                    _items.append(_item_containertype.to_dict())
            _dict['containertype'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containertype": [Huishoudelijkafvalcontainertype.from_dict(_item) for _item in obj["containertype"]] if obj.get("containertype") is not None else None
        })
        return _obj
