...
class HuishoudelijkafvaldefaultServicegebiedenLinks(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalservicegebiedenLink = Field(alias="self")
    servicegebieden_locatie: HuishoudelijkafvalservicegebiedenLocatieLink = Field(alias="servicegebiedenLocatie")
    __properties: ClassVar[List[str]] = ["schema", "self", "servicegebiedenLocatie"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of servicegebieden_locatie
        if self.servicegebieden_locatie:
            _dict['servicegebiedenLocatie'] = self.servicegebieden_locatie.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalservicegebiedenLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
            "servicegebiedenLocatie": HuishoudelijkafvalservicegebiedenLocatieLink.from_dict(obj["servicegebiedenLocatie"]) if obj.get("servicegebiedenLocatie") is not None else None
        })
        return _obj
