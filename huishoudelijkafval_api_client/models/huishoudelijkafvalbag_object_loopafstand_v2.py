...
class HuishoudelijkafvalbagObjectLoopafstandV2(BaseModel):
    """
    bagObjectLoopafstandV2
    """ # noqa: E501
    links: HuishoudelijkafvaldefaultBagObjectLoopafstandV2Links = Field(alias="_links")
    id: Annotated[str, Field(strict=True, max_length=2147483647)] = Field(description="Uniek identificerend kenmerk van het record")
    bag_object_id: Optional[Annotated[str, Field(strict=True, max_length=2147483647)]] = Field(default=None, description="Uniek identificerend kenmerk van bagobject", alias="bagObjectId")
    bag_object_type: Optional[Annotated[str, Field(strict=True, max_length=2147483647)]] = Field(default=None, description="Typering adresseerbaar object conform BAG: verblijfsobject, ligplaats , standplaats", alias="bagObjectType")
    ...
    __properties: ClassVar[List[str]] = ["_links", "id", "bagObjectId", "bagObjectType", "clusterId", "fractie", "fractieOmschrijving", "loopafstandCategorieId", "loopafstand", "geometrie", "wijzigingsdatumDp", "verwijderdDp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": HuishoudelijkafvaldefaultBagObjectLoopafstandV2Links.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "id": obj.get("id"),
