...
class HuishoudelijkafvaldefaultBagObjectLoopafstandV2Links(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalbagObjectLoopafstandV2Link = Field(alias="self")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalbagObjectLoopafstandV2Link.from_dict(obj["self"]) if obj.get("self") is not None else None,
