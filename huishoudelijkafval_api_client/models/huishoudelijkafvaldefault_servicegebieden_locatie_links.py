...
class HuishoudelijkafvaldefaultServicegebiedenLocatieLinks(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalservicegebiedenLocatieLink = Field(alias="self")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalservicegebiedenLocatieLink.from_dict(obj["self"]) if obj.get("self") is not None else None
        })
        return _obj
