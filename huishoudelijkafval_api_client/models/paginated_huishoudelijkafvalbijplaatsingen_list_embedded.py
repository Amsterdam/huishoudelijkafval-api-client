...
class PaginatedHuishoudelijkafvalbijplaatsingenListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalbijplaatsingenListEmbedded
    """ # noqa: E501
    bijplaatsingen: Optional[List[Huishoudelijkafvalbijplaatsingen]] = None
    __properties: ClassVar[List[str]] = ["bijplaatsingen"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bijplaatsingen (list)
        _items = []
        if self.bijplaatsingen:
            for _item_bijplaatsingen in self.bijplaatsingen:
                if _item_bijplaatsingen:
                    _items.append(_item_bijplaatsingen.to_dict())
            _dict['bijplaatsingen'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bijplaatsingen": [Huishoudelijkafvalbijplaatsingen.from_dict(_item) for _item in obj["bijplaatsingen"]] if obj.get("bijplaatsingen") is not None else None
        })
        return _obj
