...
class HuishoudelijkafvaldefaultContainerlocatieLinks(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalcontainerlocatieLink = Field(alias="self")
    ...
    __properties: ClassVar[List[str]] = ["schema", "self", "bagHoofdadresVerblijfsobject", "gbdBuurt", "bagOpenbareruimte", "bagNummeraanduiding"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalcontainerlocatieLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
