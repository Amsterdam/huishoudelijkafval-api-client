...
class HuishoudelijkafvaldefaultRolcontainerStatusLinks(BaseModel):
    """
    ...
    var_self: HuishoudelijkafvalrolcontainerStatusLink = Field(alias="self")
    rolcontainer: HuishoudelijkafvalrolcontainerLink
    __properties: ClassVar[List[str]] = ["schema", "self", "rolcontainer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self": HuishoudelijkafvalrolcontainerStatusLink.from_dict(obj["self"]) if obj.get("self") is not None else None,
