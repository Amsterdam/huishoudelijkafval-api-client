...
class PaginatedHuishoudelijkafvalcontainerListEmbedded(BaseModel):
    """
    PaginatedHuishoudelijkafvalcontainerListEmbedded
    """ # noqa: E501
    container: Optional[List[Huishoudelijkafvalcontainer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "container": [Huishoudelijkafvalcontainer.from_dict(_item) for _item in obj["container"]] if obj.get("container") is not None else None
        })
        return _obj
