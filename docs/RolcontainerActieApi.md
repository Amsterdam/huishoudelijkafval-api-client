...
async with huishoudelijkafval_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RolcontainerActieApi->huishoudelijkafval_rolcontainer_actie_retrieve_slash: %s\n" % e)
```
