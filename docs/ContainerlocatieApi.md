...
async with huishoudelijkafval_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ContainerlocatieApi->huishoudelijkafval_containerlocatie_retrieve_slash:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ContainerlocatieApi->huishoudelijkafval_containerlocatie_retrieve_slash: %s\n" % e)
```
