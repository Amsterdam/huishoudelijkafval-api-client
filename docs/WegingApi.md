...
async with huishoudelijkafval_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WegingApi->huishoudelijkafval_weging_list_slash:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WegingApi->huishoudelijkafval_weging_list_slash: %s\n" % e)
```
