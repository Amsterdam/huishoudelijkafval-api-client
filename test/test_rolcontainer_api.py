...
class TestRolcontainerApi(unittest.IsolatedAsyncioTestCase):
    """RolcontainerApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = RolcontainerApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_rolcontainer_list2(self) -> None:
        """Test case for huishoudelijkafval_rolcontainer_list2

        """
        pass

    async def test_huishoudelijkafval_rolcontainer_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_rolcontainer_retrieve2
