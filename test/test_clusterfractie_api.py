...
class TestClusterfractieApi(unittest.IsolatedAsyncioTestCase):
    """ClusterfractieApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ClusterfractieApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_clusterfractie_list2(self) -> None:
        """Test case for huishoudelijkafval_clusterfractie_list2

        """
        pass

    async def test_huishoudelijkafval_clusterfractie_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_clusterfractie_retrieve2
