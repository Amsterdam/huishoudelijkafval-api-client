...
class TestClusterApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_huishoudelijkafval_cluster_list2(self) -> None:
        """Test case for huishoudelijkafval_cluster_list2

        """
        pass

    async def test_huishoudelijkafval_cluster_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_cluster_retrieve2
