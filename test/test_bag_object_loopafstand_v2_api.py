...
class TestBagObjectLoopafstandV2Api(unittest.IsolatedAsyncioTestCase):
    """BagObjectLoopafstandV2Api unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = BagObjectLoopafstandV2Api()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_bag_object_loopafstand_v2_list2(self) -> None:
        """Test case for huishoudelijkafval_bag_object_loopafstand_v2_list2

        """
        pass

    async def test_huishoudelijkafval_bag_object_loopafstand_v2_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_bag_object_loopafstand_v2_retrieve2
