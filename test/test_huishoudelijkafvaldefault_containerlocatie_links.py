...
class TestHuishoudelijkafvaldefaultContainerlocatieLinks(unittest.TestCase):
    """HuishoudelijkafvaldefaultContainerlocatieLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvaldefaultContainerlocatieLinks:
        """Test HuishoudelijkafvaldefaultContainerlocatieLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvaldefaultContainerlocatieLinks`
        """
        model = HuishoudelijkafvaldefaultContainerlocatieLinks()
        if include_optional:
            return HuishoudelijkafvaldefaultContainerlocatieLinks(
                var_schema = '',
                var_self = huishoudelijkafval_api_client.models.huishoudelijkafvalcontainerlocatie_link.HuishoudelijkafvalcontainerlocatieLink(
                    href = '', 
                    title = '', 
                    id = '', ),
    ...
    def testHuishoudelijkafvaldefaultContainerlocatieLinks(self):
        """Test HuishoudelijkafvaldefaultContainerlocatieLinks"""
