...
class TestHuishoudelijkafvalwegingLink(unittest.TestCase):
    """HuishoudelijkafvalwegingLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalwegingLink:
        """Test HuishoudelijkafvalwegingLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalwegingLink`
        """
        model = HuishoudelijkafvalwegingLink()
        if include_optional:
            return HuishoudelijkafvalwegingLink(
                href = '',
                title = '',
                id = ''
            )
    ...
    def testHuishoudelijkafvalwegingLink(self):
        """Test HuishoudelijkafvalwegingLink"""
