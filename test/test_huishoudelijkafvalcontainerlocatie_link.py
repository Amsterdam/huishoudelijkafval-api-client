...
class TestHuishoudelijkafvalcontainerlocatieLink(unittest.TestCase):
    """HuishoudelijkafvalcontainerlocatieLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalcontainerlocatieLink:
        """Test HuishoudelijkafvalcontainerlocatieLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalcontainerlocatieLink`
        """
        model = HuishoudelijkafvalcontainerlocatieLink()
        if include_optional:
            return HuishoudelijkafvalcontainerlocatieLink(
                href = '',
                title = '',
                id = ''
            )
    ...
    def testHuishoudelijkafvalcontainerlocatieLink(self):
        """Test HuishoudelijkafvalcontainerlocatieLink"""
