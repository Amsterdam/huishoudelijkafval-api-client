...
class TestGebiedenStadsdelenRawIdentifier(unittest.TestCase):
    """GebiedenStadsdelenRawIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GebiedenStadsdelenRawIdentifier:
        """Test GebiedenStadsdelenRawIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GebiedenStadsdelenRawIdentifier`
        """
        model = GebiedenStadsdelenRawIdentifier()
        if include_optional:
            return GebiedenStadsdelenRawIdentifier(
                href = '',
                title = '',
                identificatie = ''
            )
    ...
    def testGebiedenStadsdelenRawIdentifier(self):
        """Test GebiedenStadsdelenRawIdentifier"""
