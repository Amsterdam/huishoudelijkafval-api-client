...
class TestBagWoonplaatsenRawIdentifier(unittest.TestCase):
    """BagWoonplaatsenRawIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BagWoonplaatsenRawIdentifier:
        """Test BagWoonplaatsenRawIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BagWoonplaatsenRawIdentifier`
        """
        model = BagWoonplaatsenRawIdentifier()
        if include_optional:
            return BagWoonplaatsenRawIdentifier(
                href = '',
                title = '',
                identificatie = ''
            )
    ...
    def testBagWoonplaatsenRawIdentifier(self):
        """Test BagWoonplaatsenRawIdentifier"""
