...
class TestBagNummeraanduidingenRawIdentifier(unittest.TestCase):
    """BagNummeraanduidingenRawIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BagNummeraanduidingenRawIdentifier:
        """Test BagNummeraanduidingenRawIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BagNummeraanduidingenRawIdentifier`
        """
        model = BagNummeraanduidingenRawIdentifier()
        if include_optional:
            return BagNummeraanduidingenRawIdentifier(
                href = '',
                title = '',
                identificatie = ''
            )
    ...
    def testBagNummeraanduidingenRawIdentifier(self):
        """Test BagNummeraanduidingenRawIdentifier"""
