...
class TestPlanningVoertuigenApi(unittest.IsolatedAsyncioTestCase):
    """PlanningVoertuigenApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = PlanningVoertuigenApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_planning_voertuigen_list2(self) -> None:
        """Test case for huishoudelijkafval_planning_voertuigen_list2

        """
        pass

    async def test_huishoudelijkafval_planning_voertuigen_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_planning_voertuigen_retrieve2
