...
class TestHuishoudelijkafvalcontainertypeLink(unittest.TestCase):
    """HuishoudelijkafvalcontainertypeLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalcontainertypeLink:
        """Test HuishoudelijkafvalcontainertypeLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalcontainertypeLink`
        """
        model = HuishoudelijkafvalcontainertypeLink()
        if include_optional:
            return HuishoudelijkafvalcontainertypeLink(
                href = '',
                title = '',
                id = ''
            )
    ...
    def testHuishoudelijkafvalcontainertypeLink(self):
        """Test HuishoudelijkafvalcontainertypeLink"""
