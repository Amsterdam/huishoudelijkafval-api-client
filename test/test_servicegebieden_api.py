...
class TestServicegebiedenApi(unittest.IsolatedAsyncioTestCase):
    """ServicegebiedenApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ServicegebiedenApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_servicegebieden_list2(self) -> None:
        """Test case for huishoudelijkafval_servicegebieden_list2

        """
        pass

    async def test_huishoudelijkafval_servicegebieden_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_servicegebieden_retrieve2
