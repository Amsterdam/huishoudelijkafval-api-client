...
class TestHuishoudelijkafvalrolcontainerLink(unittest.TestCase):
    """HuishoudelijkafvalrolcontainerLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalrolcontainerLink:
        """Test HuishoudelijkafvalrolcontainerLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalrolcontainerLink`
        """
        model = HuishoudelijkafvalrolcontainerLink()
        if include_optional:
            return HuishoudelijkafvalrolcontainerLink(
                href = '',
                title = '',
    ...
    def testHuishoudelijkafvalrolcontainerLink(self):
        """Test HuishoudelijkafvalrolcontainerLink"""
