...
class TestAdresLoopafstandV2Api(unittest.IsolatedAsyncioTestCase):
    """AdresLoopafstandV2Api unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = AdresLoopafstandV2Api()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_adres_loopafstand_v2_list2(self) -> None:
        """Test case for huishoudelijkafval_adres_loopafstand_v2_list2

        """
        pass

    async def test_huishoudelijkafval_adres_loopafstand_v2_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_adres_loopafstand_v2_retrieve2
