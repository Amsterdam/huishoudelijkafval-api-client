...
class TestHuishoudelijkafvalclusterLink(unittest.TestCase):
    """HuishoudelijkafvalclusterLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalclusterLink:
        """Test HuishoudelijkafvalclusterLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalclusterLink`
        """
        model = HuishoudelijkafvalclusterLink()
        if include_optional:
            return HuishoudelijkafvalclusterLink(
                href = '',
                title = '',
                id = ''
            )
    ...
    def testHuishoudelijkafvalclusterLink(self):
        """Test HuishoudelijkafvalclusterLink"""
