...
class TestContainerlocatieApi(unittest.IsolatedAsyncioTestCase):
    """ContainerlocatieApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ContainerlocatieApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_containerlocatie_list2(self) -> None:
        """Test case for huishoudelijkafval_containerlocatie_list2

        """
        pass

    async def test_huishoudelijkafval_containerlocatie_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_containerlocatie_retrieve2
