...
class TestWegingApi(unittest.IsolatedAsyncioTestCase):
    """WegingApi unit test stubs"""
    ...
    async def test_huishoudelijkafval_weging_list2(self) -> None:
        """Test case for huishoudelijkafval_weging_list2

        """
        pass

    async def test_huishoudelijkafval_weging_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_weging_retrieve2
