...
class TestHuishoudelijkafvalrolcontainerActieLink(unittest.TestCase):
    """HuishoudelijkafvalrolcontainerActieLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalrolcontainerActieLink:
        """Test HuishoudelijkafvalrolcontainerActieLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalrolcontainerActieLink`
        """
        model = HuishoudelijkafvalrolcontainerActieLink()
        if include_optional:
            return HuishoudelijkafvalrolcontainerActieLink(
                href = '',
                title = '',
    ...
    def testHuishoudelijkafvalrolcontainerActieLink(self):
        """Test HuishoudelijkafvalrolcontainerActieLink"""
