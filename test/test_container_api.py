...
class TestContainerApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_huishoudelijkafval_container_list2(self) -> None:
        """Test case for huishoudelijkafval_container_list2

        """
        pass

    async def test_huishoudelijkafval_container_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_container_retrieve2
