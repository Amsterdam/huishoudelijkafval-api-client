...
class TestHuishoudelijkafvalafvoermomentenLink(unittest.TestCase):
    """HuishoudelijkafvalafvoermomentenLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalafvoermomentenLink:
        """Test HuishoudelijkafvalafvoermomentenLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalafvoermomentenLink`
        """
        model = HuishoudelijkafvalafvoermomentenLink()
        if include_optional:
            return HuishoudelijkafvalafvoermomentenLink(
                href = '',
                title = '',
                id = ''
            )
    ...
    def testHuishoudelijkafvalafvoermomentenLink(self):
        """Test HuishoudelijkafvalafvoermomentenLink"""
