...
class TestHuishoudelijkafvaldefaultRolcontainerActieLinks(unittest.TestCase):
    """HuishoudelijkafvaldefaultRolcontainerActieLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvaldefaultRolcontainerActieLinks:
        """Test HuishoudelijkafvaldefaultRolcontainerActieLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvaldefaultRolcontainerActieLinks`
        """
        model = HuishoudelijkafvaldefaultRolcontainerActieLinks()
        if include_optional:
            return HuishoudelijkafvaldefaultRolcontainerActieLinks(
                var_schema = '',
                var_self = huishoudelijkafval_api_client.models.huishoudelijkafvalrolcontainer_actie_link.Huishoudelijkafvalrolcontainer_actieLink(
                    href = '', 
                    title = '', 
    ...
    def testHuishoudelijkafvaldefaultRolcontainerActieLinks(self):
        """Test HuishoudelijkafvaldefaultRolcontainerActieLinks"""
