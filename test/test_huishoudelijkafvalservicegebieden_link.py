...
class TestHuishoudelijkafvalservicegebiedenLink(unittest.TestCase):
    """HuishoudelijkafvalservicegebiedenLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HuishoudelijkafvalservicegebiedenLink:
        """Test HuishoudelijkafvalservicegebiedenLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HuishoudelijkafvalservicegebiedenLink`
        """
        model = HuishoudelijkafvalservicegebiedenLink()
        if include_optional:
            return HuishoudelijkafvalservicegebiedenLink(
                href = '',
                title = '',
                id = ''
            )
    ...
    def testHuishoudelijkafvalservicegebiedenLink(self):
        """Test HuishoudelijkafvalservicegebiedenLink"""
