...
class TestBijplaatsingenApi(unittest.IsolatedAsyncioTestCase):
    """BijplaatsingenApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = BijplaatsingenApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_huishoudelijkafval_bijplaatsingen_list2(self) -> None:
        """Test case for huishoudelijkafval_bijplaatsingen_list2

        """
        pass

    async def test_huishoudelijkafval_bijplaatsingen_retrieve2(self) -> None:
        """Test case for huishoudelijkafval_bijplaatsingen_retrieve2
